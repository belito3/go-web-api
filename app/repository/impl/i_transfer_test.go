...
func createRandomTransfer(t *testing.T, account1, account2 Account) Transfer {
	...
	transfer, err := testTransferImpl.CreateTransfer(context.Background(), arg)
...
func TestGetTransfer(t *testing.T) {
	...
	transfer2, err := testTransferImpl.GetTransfer(context.Background(), transfer1.ID)
	require.NoError(t, err)
...
func TestListTransfer(t *testing.T) {
	...
	transfers, err := testTransferImpl.ListTransfers(context.Background(), arg)
	require.NoError(t, err)
